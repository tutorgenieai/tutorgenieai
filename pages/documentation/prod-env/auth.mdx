...
sign-ups and sign-ins using multiple beautiful minimalists authentication pages. When running it in production, we are
using their live environment to host it accordingly.
...
Before you can use the authentication service in production, you need to have a domain you own that is configured
with your hosting provider. To create a production instance, you need to click on the `Create Production Instance`
button from the navigation bar of your Clerk dashboard. Fill in the required details and click on the
`Create Instance` button. This will create a production instance for your application.
